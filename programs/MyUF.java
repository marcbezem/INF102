...
public LinkedList<Integer> componentIdList(){
  ...
  for (int i=0; i<id.length; i++) if (isComponentId(i)) l.add(0,i);
  return l;
}
...
public void fastComponents(){
  ...
  for (int i=0; i<id.length; i++) a.add(new LinkedList<Integer>());
...
public static void main(String[] args){
  int N = 10;
  MyUF uf = new MyUF(N);
  uf.union(0,9); uf.union(8,9);
  uf.showComponents(); uf.fastComponents();
}//End of main
